...
#define __HAL_DMA_GET_FLAG(__HANDLE__, __FLAG__)                                                 \
    (((uint32_t)((__HANDLE__)->Instance) > ((uint32_t)DMA1_Channel8)) ? (DMA2->ISR & (__FLAG__)) \
                                                                      : (DMA1->ISR & (__FLAG__)))
#elif defined(DMA1_Channel6)
#define __HAL_DMA_GET_FLAG(__HANDLE__, __FLAG__)                                                 \
    (((uint32_t)((__HANDLE__)->Instance) > ((uint32_t)DMA1_Channel6)) ? (DMA2->ISR & (__FLAG__)) \
                                                                      : (DMA1->ISR & (__FLAG__)))
#endif /* DMA1_Channel8 */
...
#define __HAL_DMA_CLEAR_FLAG(__HANDLE__, __FLAG__)                                                \
    (((uint32_t)((__HANDLE__)->Instance) > ((uint32_t)DMA1_Channel8)) ? (DMA2->IFCR = (__FLAG__)) \
                                                                      : (DMA1->IFCR = (__FLAG__)))
#else
#define __HAL_DMA_CLEAR_FLAG(__HANDLE__, __FLAG__)                                                \
    (((uint32_t)((__HANDLE__)->Instance) > ((uint32_t)DMA1_Channel6)) ? (DMA2->IFCR = (__FLAG__)) \
                                                                      : (DMA1->IFCR = (__FLAG__)))
#endif /* DMA1_Channel8 */
