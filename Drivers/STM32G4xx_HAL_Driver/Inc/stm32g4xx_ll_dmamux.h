...
#define LL_DMAMUX_SYNC_EXTI_LINE15                                                                 \
    (DMAMUX_CxCR_SYNC_ID_3 | DMAMUX_CxCR_SYNC_ID_2 | DMAMUX_CxCR_SYNC_ID_1 | DMAMUX_CxCR_SYNC_ID_0 \
...
#define LL_DMAMUX_REQ_GEN_EXTI_LINE15                                                              \
    (DMAMUX_RGxCR_SIG_ID_3 | DMAMUX_RGxCR_SIG_ID_2 | DMAMUX_RGxCR_SIG_ID_1 | DMAMUX_RGxCR_SIG_ID_0 \
...
__STATIC_INLINE void LL_DMAMUX_SetRequestID(
    const DMAMUX_Channel_TypeDef *DMAMUXx, uint32_t Channel, uint32_t Request
)
{
    (void)(DMAMUXx);
...
LL_DMAMUX_GetRequestID(const DMAMUX_Channel_TypeDef *DMAMUXx, uint32_t Channel)
{
    (void)(DMAMUXx);
...
__STATIC_INLINE void LL_DMAMUX_SetSyncRequestNb(
    const DMAMUX_Channel_TypeDef *DMAMUXx, uint32_t Channel, uint32_t RequestNb
)
{
    (void)(DMAMUXx);
    MODIFY_REG(
...
__STATIC_INLINE void LL_DMAMUX_SetSyncPolarity(
    const DMAMUX_Channel_TypeDef *DMAMUXx, uint32_t Channel, uint32_t Polarity
)
{
    (void)(DMAMUXx);
 ...
 */
__STATIC_INLINE uint32_t
LL_DMAMUX_GetSyncPolarity(const DMAMUX_Channel_TypeDef *DMAMUXx, uint32_t Channel)
{
    (void)(DMAMUXx);
 ...
 */
__STATIC_INLINE uint32_t
LL_DMAMUX_IsEnabledEventGeneration(const DMAMUX_Channel_TypeDef *DMAMUXx, uint32_t Channel)
{
    (void)(DMAMUXx);
    return (
 ...
 */
__STATIC_INLINE uint32_t
LL_DMAMUX_IsEnabledSync(const DMAMUX_Channel_TypeDef *DMAMUXx, uint32_t Channel)
{
    (void)(DMAMUXx);
    return (
...
__STATIC_INLINE void LL_DMAMUX_SetSyncID(
    const DMAMUX_Channel_TypeDef *DMAMUXx, uint32_t Channel, uint32_t SyncID
)
{
    (void)(DMAMUXx);
 ...
 */
__STATIC_INLINE uint32_t
LL_DMAMUX_IsEnabledRequestGen(const DMAMUX_Channel_TypeDef *DMAMUXx, uint32_t RequestGenChannel)
{
    (void)(DMAMUXx);
    return (
        (READ_BIT(
...
__STATIC_INLINE void LL_DMAMUX_SetRequestGenPolarity(
    const DMAMUX_Channel_TypeDef *DMAMUXx, uint32_t RequestGenChannel, uint32_t Polarity
)
{
    UNUSED(DMAMUXx);
    MODIFY_REG(
 ...
 */
__STATIC_INLINE uint32_t
LL_DMAMUX_GetRequestGenPolarity(const DMAMUX_Channel_TypeDef *DMAMUXx, uint32_t RequestGenChannel)
{
    UNUSED(DMAMUXx);
    return (READ_BIT(
        ((DMAMUX_RequestGen_TypeDef *)((uint32_t
...
__STATIC_INLINE void LL_DMAMUX_SetGenRequestNb(
    const DMAMUX_Channel_TypeDef *DMAMUXx, uint32_t RequestGenChannel, uint32_t RequestNb
)
{
    UNUSED(DMAMUXx);
    MODIFY_REG(
 ...
 */
__STATIC_INLINE uint32_t
LL_DMAMUX_GetGenRequestNb(const DMAMUX_Channel_TypeDef *DMAMUXx, uint32_t RequestGenChannel)
{
    UNUSED(DMAMUXx);
    return (
        (READ_BIT(
...
__STATIC_INLINE void LL_DMAMUX_SetRequestSignalID(
    const DMAMUX_Channel_TypeDef *DMAMUXx, uint32_t RequestGenChannel, uint32_t RequestSignalID
)
{
    UNUSED(DMAMUXx);
    MODIFY_REG(
 ...
 */
__STATIC_INLINE uint32_t
LL_DMAMUX_GetRequestSignalID(const DMAMUX_Channel_TypeDef *DMAMUXx, uint32_t RequestGenChannel)
{
    UNUSED(DMAMUXx);
    return (READ_BIT(
        ((DMAMUX_RequestGen_TypeDef *)((uint32_t
 ...
 */
__STATIC_INLINE uint32_t
LL_DMAMUX_IsEnabledIT_SO(const DMAMUX_Channel_TypeDef *DMAMUXx, uint32_t Channel)
{
    (void)(DMAMUXx);
    return (
 ...
 */
__STATIC_INLINE uint32_t
LL_DMAMUX_IsEnabledIT_RGO(const DMAMUX_Channel_TypeDef *DMAMUXx, uint32_t RequestGenChannel)
{
    UNUSED(DMAMUXx);
    return (
        (READ_BIT(
